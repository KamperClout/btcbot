...
usd = 'COST'
ablockchain = 'BOT'
monitoringhigh= 'MAX SOL'
monitoringlow = 'MIN SOL'
monitoringopen = 'OPEN SOL'
monitoringclose='СLOSE SOL'
monitoringvolume = 'VOL SOL'
...
def message_handler(update: Update, context: CallbackContext):
    ...
    update.message.reply_text(
        text='Привет! 👋 SOL на связи 🚀'
             '\n дроп ПО [Cryptolia] ожидается 18.03.22!'
             '\n🚨 Бот даёт бесплатные сигналы по высоким и низким точкам SOL'
...
def main():
    print('Start')
    updater = Updater(
    token='5110215450:AAHOcLCvgU93Hmy51BZzoaojfi_kxHlizjc',
    use_context=True,
    )
