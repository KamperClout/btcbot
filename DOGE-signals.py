...
# УСТАНОВИТЕ НУЖНЫЕ БИБЛИОТЕКИ, ВСЕ ПОДРОБНОСТИ - https://www.youtube.com/channel/UCNsCG28uQxTz6kL2HvLpUxw
...
usd = 'COST'
ablockchain = 'BOT'
monitoringhigh= 'MAX DOG'
monitoringlow = 'MIN DOG'
monitoringopen = 'OPEN DOG'
monitoringclose='СLOSE DOG'
monitoringvolume = 'VOL DOG'
...
def message_handler(update: Update, context: CallbackContext):
    ...
    update.message.reply_text(
        text='Привет! 👋 DOGE на связи 🚀'
             '\nдроп ПО [Cryptolia] ожидается 18.03.22!'
             '\n 🚨 Бот даёт бесплатные сигналы по высоким и низким точкам DOGE'
...
def main():
    print('Start')
    updater = Updater(
    token='5139304278:AAGr427TrGRjXVX-KYFh3ZcJCRVASW5W-WE',
    use_context=True,
    )
