...
usd = 'COST'
ablockchain = 'BOT'
monitoringhigh= 'MAX BTC'
monitoringlow = 'MIN BTC'
monitoringopen = 'OPEN BTC'
monitoringclose='СLOSE BTC'
monitoringvolume = 'VOL BTC'
...
def message_handler(update: Update, context: CallbackContext):
    ...
    update.message.reply_text(
        text='Привет! 👋 BTC на связи 🚀'
             '\nдроп ПО [Cryptolia] ожидается 18.03.22!'
             '\n 🚨 Бот даёт бесплатные сигналы по высоким и низким точкам BTC'
...
def main():
    print('Start')
    updater = Updater(
    token='5169723517:AAF_97QxQSUT3VEGGnrEO6poUL6vskpUO_E',
    use_context=True,
    )
